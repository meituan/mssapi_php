...
The actual object returned by ``getIterator()`` is an instance of the ``Mss\Common\Iterator\MssResourceIterator`` class
(see the `API docs <http://docs.aws.amazon.com/aws-sdk-php/v2/api/class-Mss.Common.Iterator.MssResourceIterator.html>`_
