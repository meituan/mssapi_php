...
class ClearBucket extends AbstractHasDispatcher
{
    ...
    /**
     * @var MssClientInterface Client used to execute the requests
     */
    protected $client;
    ...
    /**
     * @param MssClientInterface $client Client used to execute requests
     * @param string             $bucket Name of the bucket to clear
     */
    public function __construct(MssClientInterface $client, $bucket)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    }
