...
namespace Mss\Common\Exception;

use Mss\Common\Model\MultipartUpload\TransferStateInterface;

/**
 * Thrown when a {@see Mss\Common\MultipartUpload\TransferInterface} object encounters an error during transfer
 */
