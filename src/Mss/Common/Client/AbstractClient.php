...
use Mss\Common\Exception\TransferException;
...
use Mss\Common\Signature\SignatureListener;
use Mss\Common\Waiter\WaiterClassFactory;
use Mss\Common\Waiter\CompositeWaiterFactory;
use Mss\Common\Waiter\WaiterFactoryInterface;
use Mss\Common\Waiter\WaiterConfigFactory;
 ...
 * Abstract AWS client
 */
abstract class AbstractClient extends Client implements MssClientInterface
{
    ...
    public function __construct(CredentialsInterface $credentials, SignatureInterface $signature, Collection $config)
    {
        ...
        $this->setUserAgent('mss-sdk-php2/' . Mss::VERSION, true);
    ...
    /**
     * {@inheritdoc}
     * @throws \Mss\Common\Exception\TransferException
     */
