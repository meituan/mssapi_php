...
class DefaultClient extends AbstractClient
{
     ...
     * - credentials: You can optionally provide a custom `Mss\Common\Credentials\CredentialsInterface` object
     ...
     *
     * - signature: Overrides the signature used by the client. Clients will always choose an appropriate default signature. However, it can be useful to override this with a custom setting. This can be set to "v4", "v3https", "v2" or an instance of Mss\Common\Signature\SignatureInterface.
