...
namespace Mss\Common\Client;

use Mss\Common\Credentials\Credentials;
use Mss\Common\Credentials\CredentialsInterface;
use Mss\Common\Credentials\NullCredentials;
use Mss\Common\Enum\ClientOptions as Options;
use Mss\Common\Exception\ExceptionListener;
use Mss\Common\Exception\InvalidArgumentException;
use Mss\Common\Exception\NamespaceExceptionFactory;
use Mss\Common\Exception\Parser\DefaultXmlExceptionParser;
use Mss\Common\Exception\Parser\ExceptionParserInterface;
use Mss\Common\Iterator\MssResourceIteratorFactory;
use Mss\Common\RulesEndpointProvider;
use Mss\Common\Signature\EndpointSignatureInterface;
use Mss\Common\Signature\SignatureInterface;
use Mss\Common\Signature\SignatureV2;
use Mss\Common\Signature\SignatureV3Https;
...
class ClientBuilder
{
    ...
    public function __construct($namespace = null)
    {
        ...
        $this->clientClass = 'Mss\Common\Client\DefaultClient';
    ...
    public function build()
    {
        ...
        $client->setResourceIteratorFactory(new MssResourceIteratorFactory(
     ...
     * version identifier string or an instance of Mss\Common\Signature\SignatureInterface.
     *
    ...
    protected function getSignature(ServiceDescription $description, Collection $config)
    {
        ...
        if (is_string($signature)) {
            ...
            throw new InvalidArgumentException('The provided signature is not '
                ...
                . 'Mss\\Common\\Signature\\SignatureInterface');
        }
