...
namespace Mss\Common\InstanceMetadata;

use Mss\Common\Enum\ClientOptions as Options;
use Mss\Common\Exception\InstanceProfileCredentialsException;
    ...
    public function getInstanceProfileCredentials()
    {
        try {
            ...
            $message = sprintf('Error retrieving credentials from the instance profile metadata server. When you are'
                ...
                . ' Mss\\Common\\Credentials\\CredentialsInterface object. (%s)', $e->getMessage());
