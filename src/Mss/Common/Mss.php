 ...
 */
class Mss extends ServiceBuilder
{
    /**
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        $loader->addAlias('_mss', self::getDefaultServiceDefinition())
    ...
    {
        return __DIR__  . '/Resources/mss-config.php';
    }
