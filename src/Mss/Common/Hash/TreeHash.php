...
namespace Mss\Common\Hash;

use Mss\Common\Enum\Size;
use Mss\Common\Exception\InvalidArgumentException;
use Mss\Common\Exception\LogicException;
...
class TreeHash implements ChunkHashInterface
{
    ...
    public static function fromChecksums(array $checksums, $inBinaryForm = false, $algorithm = self::DEFAULT_ALGORITHM)
    {
        ...
        $treeHash->checksums = $inBinaryForm ? $checksums : array_map('Mss\Common\Hash\HashUtils::hexToBin', $checksums);
