...
namespace Mss\Common\Model\MultipartUpload;
...
{
    /**
     * @var MssClientInterface Client used to transfer requests
     */
    protected $client;
     ...
     *
     * @param MssClientInterface $client Client to use
     *
     * @return $this
     */
    public function setClient(MssClientInterface $client)
    {
        $this->client = $client;
