...
namespace Mss\S3\Integration;

use Mss\S3\Enum\Group;
use Mss\S3\Enum\Permission;
use Mss\S3\Model\Acp;
use Mss\S3\Model\AcpBuilder;
use Mss\S3\Model\Grant;
use Mss\S3\Model\Grantee;
use Mss\S3\S3Client;
 ...
 */
class S3_20060301_Test extends \Mss\Tests\IntegrationTestCase
{
    const TEST_KEY = 'foo';
     ...
     *
     * @expectedException \Mss\S3\Exception\BucketAlreadyExistsException
     * @example Mss\S3\S3Client::createBucket
     */
     ...
     * @example Mss\S3\S3Client::waitUntilBucketExists
     */
     ...
     * @example Mss\S3\S3Client::putObject
     */
     ...
     * @example Mss\S3\S3Client::listBuckets
     */
     ...
     * @example Mss\S3\S3Client::listObjects
     */
     ...
     * @example Mss\S3\S3Client::getObject
     */
     ...
     * @example Mss\S3\S3Client::createPresignedUrl
     * @example Mss\S3\Command\S3Command::createPresignedUrl
     */
     ...
     */
    public function no_testPutObjectSigV4()
    {
