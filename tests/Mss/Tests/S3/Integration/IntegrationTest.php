...
namespace Mss\Tests\S3\Integration;
 ...
 * @group integration
 */
class IntegrationTest extends \Mss\Tests\IntegrationTestCase
{
    const TEST_KEY = 'foo';
    ...
    public function testSignsPathBucketsCorrectly()
    {
        ...
        } catch (\Mss\S3\Exception\SignatureDoesNotMatchException $e) {
    ...
    /**
     * @depends testHeadBucket
     * @expectedException \Mss\S3\Exception\NoSuchBucketPolicyException
     */
    ...
    /**
     * @depends testHeadBucket
     * @expectedException \Mss\S3\Exception\NoSuchWebsiteConfigurationException
     */
     ...
     */
    public function no_testCanSendRawHttpRequests()
    {
        $this->client->waitUntil('bucket_exists', array('Bucket' => $this->bucket));
    ...
    public function notestUsesTieredStorage()
    {
