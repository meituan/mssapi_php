...
use Mss\S3\Model\DeleteObjectsTransfer;
use Mss\S3\Exception\DeleteMultipleObjectsException;

/**
 * @covers Mss\S3\Model\DeleteObjectsTransfer
 */
class DeleteObjectsTransferTest extends \Guzzle\Tests\GuzzleTestCase
{
    /**
     * @expectedException \Mss\S3\Exception\InvalidArgumentException
     */
    ...
    /**
     * @expectedException \Mss\Common\Exception\OverflowException
     */
