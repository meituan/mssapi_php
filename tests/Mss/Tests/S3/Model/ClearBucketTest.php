...
/**
 * @covers Mss\S3\Model\ClearBucket
 */
class ClearBucketTest extends \Guzzle\Tests\GuzzleTestCase
{
    public function testAllowsGettersAndSetters()
    {
        ...
        $iterator = $this->getMockForAbstractClass('Mss\Common\Iterator\MssResourceIterator', array(), '', false);
    ...
    {
        $clear = new ClearBucket($this->getServiceBuilder()->get('s3'), 'foo');
        $this->assertInstanceOf('Mss\Common\Iterator\MssResourceIterator', $clear->getIterator());
    }
