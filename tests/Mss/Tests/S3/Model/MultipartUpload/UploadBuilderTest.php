...
use Mss\S3\Model\MultipartUpload\UploadId;
use Guzzle\Http\EntityBody;

/**
 * @covers Mss\S3\Model\MultipartUpload\UploadBuilder
 */
class UploadBuilderTest extends \Guzzle\Tests\GuzzleTestCase
{
    public function testHasChainableMethodToInstantiate()
    {
        $this->assertInstanceOf('Mss\S3\Model\MultipartUpload\UploadBuilder', UploadBuilder::newInstance());
    }
    ...
    public function testHasChainableSetterMethods()
   {
    ...
    public function testCanCreateNewStateByInitiatingMultipartUpload()
    {
        ...
        $this->assertEquals('/foo/bar?uploads', $requests[0]->getResource());
