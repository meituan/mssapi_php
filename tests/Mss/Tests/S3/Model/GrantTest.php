...
/**
 * @covers Mss\S3\Model\Grant
 */
class GrantTest extends \Guzzle\Tests\GuzzleTestCase
{
    public function testCanSetValues()
    {
        $grantee = $this->getMockBuilder('Mss\S3\Model\Grantee')->disableOriginalConstructor()->getMock();
        ...
        $anotherGrantee = $this->getMockBuilder('Mss\S3\Model\Grantee')->disableOriginalConstructor()->getMock();
