...
$autoloaderFilename = 'mss-autoloader.php';
...
$burgomaster->recursiveCopy('src/Mss', 'Mss', ['php', 'json']);
...
$burgomaster->createZip(__DIR__ . '/artifacts/mss.zip');
$burgomaster->createPhar(__DIR__ . '/artifacts/mss.phar', null, $autoloaderFilename);
